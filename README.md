...
사용자의 실시간 GPS 좌표를 분석하여 기상청의 정밀한 단기예보 데이터를 가져오고, 이를 생성형 AI가 분석하여 최적의 의상을 추천해 주는 풀스택 웹 애플리케이션입니다. 단순한 수치 제공을 넘어, 사용자가 직관적으로 오늘 무엇을 입을지 결정할 수 있도록 돕는 대시보드를 제공합니다.
